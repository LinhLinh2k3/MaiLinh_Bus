...
namespace NhaXeMaiLinh.Migrations
{
    ...
    [Migration("20241214124554_AddIsEnabledToTuyenDuong")]
    partial class AddIsEnabledToTuyenDuong
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NhaXeMaiLinh.Models.Data.KhuyenMai", b =>
                {
            ...
            modelBuilder.Entity("NhaXeMaiLinh.Models.Data.KhuyenMai_KH", b =>
                {
                    b.Property<string>("KhuyenMaiID")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("KhuyenMaiID", "KhachHangID");

                    b.HasIndex("KhachHangID");

                    b.ToTable("KhuyenMai_KHs");
                });
            ...
            modelBuilder.Entity("NhaXeMaiLinh.Models.Data.LichSuDoiGhe", b =>
                {
                    ...
                    b.Property<int>("GheCu")
                        .HasColumnType("int");

                    b.Property<int>("GheMoi")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NhaXeMaiLinh.Models.Data.ChiTietVeDat", b =>
                {
                    b.HasOne("NhaXeMaiLinh.Models.Data.VeXe", "VeXe")
                        .WithMany("ChiTietVeDats")
                        .HasForeignKey("VeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NhaXeMaiLinh.Models.Data.Ghe", "Ghe")
                        .WithMany()
                        .HasForeignKey("SoGhe", "XeID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NhaXeMaiLinh.Models.Data.KhuyenMai_KH", b =>
                {
                    ...
                    b.HasOne("NhaXeMaiLinh.Models.Data.KhuyenMai", "KhuyenMai")
                        .WithMany()
            ...
            modelBuilder.Entity("NhaXeMaiLinh.Models.Data.NhanVien", b =>
                {
                    b.HasOne("NhaXeMaiLinh.Models.Data.AppUser", "AppUser")
                        .WithOne("NhanVien")
                        .HasForeignKey("NhaXeMaiLinh.Models.Data.NhanVien", "AppUserId");
